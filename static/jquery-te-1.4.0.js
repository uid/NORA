...
(function($){		
	$.fn.jqte = function(options){
		...
		// methods
        $.fn.jqteText = function() {
            var text = $(this).closest("."+vars.css).find("."+vars.css+"_editor").html();
            return text;
        }
        
        $.fn.jqteAddTags = function(value) {
            tags = tags + value;
        }
        
        $.fn.jqteClearTags = function(value) {
            tags = "";
        }
        
        $.fn.jqteTags = function(value) {
            return tags;
        }
